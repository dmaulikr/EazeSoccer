//
//  EazesportzTimeOfTimeOutViewController.m
//  EazeSportz
//
...
@interface EazesportzTimeOfTimeOutViewController ()

@end

@implementation EazesportzTimeOfTimeOutViewController
...
- (void)viewWillAppear:(BOOL)animated {
    ...
    _periodLabel.text = [NSString stringWithFormat:@"Period - %@", [period stringValue]];
}
