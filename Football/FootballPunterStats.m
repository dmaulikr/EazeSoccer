        ...
        dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0), ^{
            ...
            if (football_punter_id.length > 0) {
                aurl = [NSURL URLWithString:[NSString stringWithFormat:@"%@%@%@%@%@%@%@%@%@", [mainBundle objectForInfoDictionaryKey:@"SportzServerUrl"],
                                             @"/sports/", currentSettings.sport.id, @"/athletes/", athlete_id, @"/football_punters/", football_punter_id,
                                             @".json?auth_token=", currentSettings.user.authtoken]];
                
            } else {
                aurl = [NSURL URLWithString:[NSString stringWithFormat:@"%@%@%@%@%@%@%@%@%@", [mainBundle objectForInfoDictionaryKey:@"SportzServerUrl"],
                                             @"/sports/", currentSettings.sport.id, @"/athletes/", athlete_id, @"/football_punters.json?gameschedule_id=",
...
//                    [[[currentSettings findAthlete:athlete_id] football_punter_stats] addObject:self];
                }
            } else {
