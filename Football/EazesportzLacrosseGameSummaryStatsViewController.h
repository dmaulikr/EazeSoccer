//
//  EazesportzLacrosseGameSummaryStatsViewController.h
//  EazeSportz
//
...
@interface EazesportzLacrosseGameSummaryStatsViewController : EazesportzLacrosseGameStatsViewController
