...
- (BOOL)saveStats {
    if (([fumbles_lost intValue] > 0) || ([fumbles intValue] > 0) || ([longest intValue] > 0) || ([receptions intValue] > 0) ||
        ...
        if (football_receiving_id.length > 0) {
            ...
            aurl = [NSURL URLWithString:[NSString stringWithFormat:@"%@%@%@%@%@%@%@%@%@", [mainBundle objectForInfoDictionaryKey:@"SportzServerUrl"],
                                         @"/sports/", currentSettings.sport.id, @"/athletes/", athlete_id, @"/football_receivings.json?gameschedule_id=",
